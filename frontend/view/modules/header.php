...
<li>|</li>
<li>
<a href="#createAccountModal" data-toggle="model">Create an account</a>
</li>
</ul>
</div>
</div>
...
<a href="#">
<img src="http://localhost/univa-ecommerce/backend/view/img/template/logo.png" class="img-responsive" alt="univa-ecommerse">
</a>
</div>
...
<!-- Categories button -->
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 backgroundColor" id="buttonCategories">
<p>Categories 
